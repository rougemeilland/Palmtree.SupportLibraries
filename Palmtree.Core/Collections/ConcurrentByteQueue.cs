...
{
    public class ConcurrentByteQueue
        : IDisposable, IAsyncDisposable
    {
        ...
        private Boolean _processingReader;
        private Boolean _processingWriter;

        public ConcurrentByteQueue(Int32 bufferSize = _DEFAULT_BUFFER_SIZE)
        {
