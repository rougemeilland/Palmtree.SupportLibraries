...
namespace Test.Palmtree.Core
{
    public sealed partial class TestArrayExtensions
    {
        ...
        private void TestMaxIeee754FloatingCore<ELEMENT_T>()
            where ELEMENT_T : struct, INumber<ELEMENT_T>, IFloatingPointIeee754<ELEMENT_T>
        {
            var sourceBuffer = ArrayPool<ELEMENT_T>.Shared.Rent(129);
