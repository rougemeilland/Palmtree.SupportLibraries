...
namespace Palmtree.IO.Compression.Archive.Zip.ExtraFields
{
        ...
        : IExtraField
    {
        ...
        /// </list>
        /// </remarks>
        public abstract ReadOnlyMemory<Byte>? GetData(ZipEntryHeaderType headerType, IExtraFieldEncodingParameter parameter);
        ...
        /// </para>
        /// <para>
        /// このメソッドに与えるパラメタは、<see cref="SetData(ZipEntryHeaderType, ReadOnlyMemory{Byte}, IExtraFieldDecodingParameter)"/> で与えられた <paramref name="headerType"/> と <paramref name="data"/> です。
        /// </para>
        /// </description>
        /// </item>
        /// </list>
        /// </remarks>
        public abstract void SetData(ZipEntryHeaderType headerType, ReadOnlyMemory<Byte> data, IExtraFieldDecodingParameter parameter);
