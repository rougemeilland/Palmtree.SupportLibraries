namespace Palmtree.IO.Console
{
    ...
    internal enum EastAsianWidthType
    {
        ...
        /// <remarks>
        /// <para>
        /// <see cref="Fullwidth"/> 以外で、東アジアの従来文字コードではいわゆる全角であった文字です。
        /// </para>
        /// <para>
        ...
        /// <remarks>
        /// <para>
        /// <see cref="Halfwidth"/> 以外の文字で、東アジアの従来文字コードにおいて対応するいわゆる全角文字が存在した半角文字です。
        /// </para>
        /// <para>
        /// 例) 半角英数など。
        /// </para>
        ...
        /// <para>
        /// 文脈によって文字幅が異なる文字です。
        /// 東アジアの組版とそれ以外の組版の両方に出現し、東アジアの従来文字コードではいわゆる全角として扱われることがあります。
        /// </para>
        /// <para>
        /// 例) ギリシア文字やキリル文字など。
        /// </para>
